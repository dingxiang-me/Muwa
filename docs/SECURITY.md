...
We take the security of Muwa seriously. If you believe you have found a security vulnerability, please follow the process below.
...
These are the boundaries Muwa relies on. Detailed mechanisms live in [`IDENTITY.md`](IDENTITY.md), [`SANDBOX.md`](SANDBOX.md), and [`STORAGE.md`](STORAGE.md).
