...
final class ManifestExtractTests: XCTestCase {
    ...
    override func setUp() {
        ...
        tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("muwa-manifest-test-\(UUID().uuidString)", isDirectory: true)
    ...
    func testErrorDescriptions() {
        let cases: [(ManifestExtract.ExtractionError, String)] = [
            ...
            (.missingEntryPoint, "Missing plugin entry point (muwa_plugin_entry or muwa_plugin_entry_v2)"),
