...
//  Muwa
//
//  Command to show the Muwa menu bar popover UI by sending a distributed notification to the app.
//
    ...
    public static func execute(args: [String]) async {
        ...
        while Date() < deadline {
            ...
            if await ServerControl.checkHealth(port: port) {
                AppControl.postDistributedNotification(name: "com.dinoki.muwa.control.ui", userInfo: [:])
