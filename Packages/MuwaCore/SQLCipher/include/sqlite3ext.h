...
/*
 * BEGIN MUWA LOCAL MODIFICATION (do not remove on SQLCipher
 * version bumps; re-apply after copying a new sqlite3ext.h).
 *
 * Muwa imports SQLCipher from Swift for the core SQLite API, not
 ...
 * build error.
 *
 * The umbrella header defines MUWA_OMIT_SQLITE_EXTENSION_API
 * before including this file so the module stays warning-free without
 * exporting the loadable-extension API that Muwa does not use.
...
#endif /* MUWA_OMIT_SQLITE_EXTENSION_API - END MUWA LOCAL MODIFICATION */
