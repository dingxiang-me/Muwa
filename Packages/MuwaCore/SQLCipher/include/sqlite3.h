 ...
 *
 * Muwa only uses FTS5 from SQL (`CREATE VIRTUAL TABLE … USING
 ...
 * `Packages/MuwaCore/SQLCipher/sqlcipher_amalgamation.c`.
 *
 * To re-enable: drop `MUWA_OMIT_FTS5_HEADERS` from
 * `Packages/MuwaCore/Package.swift` cSettings.
 */
