 ...
 *  Consumers `import MuwaSQLCipher` (Swift) and call the standard
...
#ifndef MUWA_SQLCIPHER_H
#define MUWA_SQLCIPHER_H
...
#define MUWA_OMIT_FTS5_HEADERS 1
#endif
 ...
 * Muwa does not compile SQLite loadable extensions, and newer
 * macOS SDKs may expose extension fields that SQLCipher 4.6.1 does
 * not. This silences the
 *
 *   warning: umbrella header for module 'MuwaSQLCipher' does not
...
#ifndef MUWA_OMIT_SQLITE_EXTENSION_API
#define MUWA_OMIT_SQLITE_EXTENSION_API 1
#endif
