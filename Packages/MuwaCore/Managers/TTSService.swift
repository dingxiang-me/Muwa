...
extension Notification.Name {
    ...
    public static let openTTSSettingsRequested = Notification.Name("muwa.openTTSSettingsRequested")
    ...
    public static let ttsPlaybackStateChanged = Notification.Name("muwa.ttsPlaybackStateChanged")
}
