...
public final class ToastManager {
    ...
    private init() {
        ...
        print("[Muwa] ToastManager initialized with position: \(configuration.position.displayName)")
    }
    ...
    public func updateConfiguration(_ configuration: ToastConfiguration) {
        ...
        print("[Muwa] Toast configuration updated: position=\(configuration.position.displayName)")
    }
    ...
    public func show(_ toast: Toast) -> UUID {
        guard configuration.enabled else {
            print("[Muwa] Toast suppressed (disabled): \(toast.title)")
            return toast.id
        }
        ...
        print("[Muwa] Toast shown: \(toast.type.rawValue) - \(toast.title)")
    ...
    public func dismissAll() {
        ...
        print("[Muwa] All toasts dismissed")
    }
    ...
    public func update(
        ...
        guard let index = toasts.firstIndex(where: { $0.id == id }) else {
            print("[Muwa] Toast not found for update: \(id)")
            return
        }
        ...
        print("[Muwa] Toast updated: \(id) - \(toast.type.rawValue) - \(toast.title)")
    }
