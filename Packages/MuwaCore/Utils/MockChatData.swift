...
//
    ...
    enum MockChatData {
        ...
        private static let mockArtifactRootURL: URL = {
            ...
            let dir = base.appendingPathComponent("muwa-mock-\(UUID().uuidString)", isDirectory: true)
            ...
            case 4:
                ...
                turn.toolCalls = [
                    ToolCall(
                        ...
                        function: ToolCallFunction(
                            name: "run_command",
                            arguments: "{\"command\": \"xcodebuild -scheme Muwa test\"}"
                        )
                    )
                ]
        ...
        private static let markdownRichStatic = """
            ...
            ```bash
            xcodebuild -scheme Muwa -destination 'platform=macOS' build 2>&1 | tail -n 20
            ```
            """
