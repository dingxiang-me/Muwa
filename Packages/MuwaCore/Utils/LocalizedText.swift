...
extension Text {
    /// Localized label from the MuwaCore string catalog (`bundle: .module`).
...
extension Button where Label == Text {
    /// Localized text button from the MuwaCore string catalog (`bundle: .module`).
...
extension View {
    /// Tooltip from the MuwaCore string catalog (`bundle: .module`).
