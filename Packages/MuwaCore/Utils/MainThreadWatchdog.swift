...
//  `log show --predicate 'subsystem == "com.dinoki.muwa"'`) so support can
...
final class MainThreadWatchdog: @unchecked Sendable {
    ...
    private static let log = Logger(subsystem: "com.dinoki.muwa", category: "MainThreadWatchdog")

    private let threshold: TimeInterval
    private var timer: DispatchSourceTimer?
    private let queue = DispatchQueue(label: "com.muwa.watchdog", qos: .background)
