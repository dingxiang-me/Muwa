...
///
/// Persisted as `~/.muwa/agents/<uuid>/installed-packages.json`.
...
public final class SandboxPackageManifest: @unchecked Sendable {
    ...
    public func clear(agentId: String) {
        ...
        try? FileManager.default.removeItem(at: MuwaPaths.agentPackageManifestFile(for: uuid))
    }
    ...
    private func loadLocked(_ id: UUID) -> Installed {
        ...
        let url = MuwaPaths.agentPackageManifestFile(for: id)
