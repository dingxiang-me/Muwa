...
private let poolLogger = Logger(subsystem: "ai.muwa", category: "core_model")
...
public actor GenerativeGreetingPool {
    ...
    /// `MuwaPaths.greetingPoolCacheFile()` — the very first chat
    ...
    private func restoreFromDisk() async {
        ...
        let url = MuwaPaths.greetingPoolCacheFile()
