...
//  files Muwa downloads for a repo). Replaces the hand-coded
...
enum ModelSizeCache {
    ...
    struct Entry: Codable {
        /// Total bytes of the files Muwa downloads for this repo.
        let bytes: Int64
    ...
    /// Used by tests after pointing `MuwaPaths` at a fixture root.
    ...
    private static func loadFromDisk() -> [String: Entry] {
        let url = MuwaPaths.modelSizeCacheFile()
