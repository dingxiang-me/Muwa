...
private let logger = Logger(subsystem: "ai.muwa", category: "CapabilitySearch")
...
enum CapabilitySearch {
    ...
    /// recall repro.
    private static let debugTraceEnvVar = "MUWA_DEBUG_CAPABILITY_SEARCH"
    ...
    /// only fires when `MUWA_DEBUG_CAPABILITY_SEARCH=1`.
