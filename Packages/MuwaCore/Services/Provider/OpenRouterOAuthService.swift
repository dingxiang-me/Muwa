...
public enum OpenRouterOAuthService {
    ...
    /// Single source of truth for Muwa's identity to OpenRouter. The same
    ...
    public enum Attribution {
        ...
        public static let referrerURL = "https://muwa.ai"
        public static let appTitle = ProductBrand.name
    ...
    public static func exchangeCodeForKey(_ code: String, verifier: String) async throws -> String {
        ...
        // same Muwa identity that future chat-completion requests present.
        ...
        request.httpBody = try JSONSerialization.data(withJSONObject: body, options: .muwaCanonical)
