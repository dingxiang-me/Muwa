...
//  Muwa
//
//  Client side of the Muwa Secure Channel. Owns one established session
//  per remote Muwa provider (keyed by provider id + pinned agent address),
...
public enum SecureChannelClientError: Error, LocalizedError, Equatable {
    ...
    public var errorDescription: String? {
        ...
        case .peerUnsupported:
            return
                "This peer's Muwa version does not support end-to-end encryption. Ask them to upgrade Muwa."
        case .missingAgentAddress:
