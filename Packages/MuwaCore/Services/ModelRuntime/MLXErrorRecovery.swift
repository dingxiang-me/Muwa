...
//  Metal validation failure) takes the entire Muwa process down, killing every
...
//  `NemotronHJANGTQ.swift`; on the Muwa side we want the server to keep
...
private let recoveryLog = Logger(subsystem: "com.dinoki.muwa", category: "MLXErrorRecovery")
