...
public final class TelemetryService {
    ...
    /// MuwaCore as a product) still can't construct its own instance.
    init(
    ...
    nonisolated private static let remoteIdSalt = "muwa.telemetry.remote-id.v1"
    ...
    ///      `App/Muwa/Secrets.xcconfig` (the project's Debug base config. see
