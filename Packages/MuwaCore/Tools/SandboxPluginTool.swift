...
//  Muwa
//
//  Wraps a sandbox plugin tool spec as an MuwaTool.
...
final class SandboxPluginTool: MuwaTool, @unchecked Sendable {
    let name: String
    ...
    private func buildParamVars(from args: [String: Any]) -> [String: String] {
        ...
        for (key, value) in args {
            ...
            } else if let data = try? JSONSerialization.data(withJSONObject: value, options: .muwaCanonical),
