...
//  tool providers:
//   - muwa_mcp_add     — register an HTTP MCP server
//   - muwa_mcp_remove  — delete a registered MCP server
//   - muwa_mcp_enable  — enable / disable a registered MCP server
//
...
public final class MuwaMCPAddTool: MuwaTool, PermissionedTool, @unchecked Sendable {
    public let name = "muwa_mcp_add"
    ...
    public func execute(argumentsJSON: String) async throws -> String {
        ...
        if needsSecrets {
            result["next_steps"] = [
                ...
                "Use muwa_list({scope: 'mcp'}) to confirm connection status.",
            ]
        } else {
            result["next_steps"] = [
                "Use muwa_list({scope: 'mcp'}) to confirm the server connected."
            ]
        }
...
// MARK: - muwa_mcp_remove

public final class MuwaMCPRemoveTool: MuwaTool, PermissionedTool, @unchecked Sendable {
    public let name = "muwa_mcp_remove"
    public let description =
...
// MARK: - muwa_mcp_enable

public final class MuwaMCPEnableTool: MuwaTool, PermissionedTool, @unchecked Sendable {
    public let name = "muwa_mcp_enable"
    public let description =
