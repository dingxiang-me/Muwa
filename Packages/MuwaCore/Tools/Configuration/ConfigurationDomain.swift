...
///
/// Kept module-internal because `tools: [any MuwaTool]` would
/// otherwise leak the internal `MuwaTool` protocol through a
...
final class ConfigurationDomainRegistry: ObservableObject {
    ...
    /// "connect anthropic" can rank `muwa_provider_add` even when
