...
private struct SandboxInitPendingTool: MuwaTool, @unchecked Sendable {
...
private struct SandboxReadFileTool: MuwaTool, @unchecked Sendable {
...
private struct SandboxSearchFilesTool: MuwaTool, @unchecked Sendable {
...
private struct SandboxWriteFileTool: MuwaTool, @unchecked Sendable {
...
private struct SandboxExecTool: MuwaTool, @unchecked Sendable {
...
private struct SandboxProcessTool: MuwaTool, @unchecked Sendable {
...
/// dispatch layer.
private struct SandboxInstallTool: MuwaTool, @unchecked Sendable {
