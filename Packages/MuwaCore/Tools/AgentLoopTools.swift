...
//
//  These are normal `MuwaTool`s. They execute through `ToolRegistry`
...
public final class TodoTool: MuwaTool, @unchecked Sendable {
...
public final class CompleteTool: MuwaTool, @unchecked Sendable {
...
/// resumes from there.
public final class ClarifyTool: MuwaTool, @unchecked Sendable {
...
public final class SpeakTool: MuwaTool, @unchecked Sendable {
