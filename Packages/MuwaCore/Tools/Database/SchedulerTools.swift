...
final class ScheduleNextRunTool: MuwaTool, @unchecked Sendable {
...
final class CancelNextRunTool: MuwaTool, @unchecked Sendable {
...
final class NotifyTool: MuwaTool, @unchecked Sendable {
    let name = "notify"
    let description =
