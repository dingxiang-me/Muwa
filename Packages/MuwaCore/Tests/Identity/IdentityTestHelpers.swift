...
/// A pair of (privateKey, muwaAddress) for use in tests.
...
enum TestKeys {
    ...
    static var aliceAddress: MuwaID { try! deriveMuwaId(from: alicePrivateKey) }
    ...
    static var bobAddress: MuwaID { try! deriveMuwaId(from: bobPrivateKey) }
    ...
    static var carolAddress: MuwaID { try! deriveMuwaId(from: carolPrivateKey) }
}
...
enum TokenBuilder {
    static func build(
        ...
        lbl: String? = "test",
        signingPrefix: String = "Muwa Signed Access"
    ) throws -> String {
...
extension APIKeyValidator {
    ...
    static func forAlice(
        agentAddress: MuwaID? = nil,
        extraWhitelist: Set<MuwaID> = [],
        ...
        var wl: Set<MuwaID> = [master.lowercased(), agent.lowercased()]
