...
struct PluginManagerReconnectDetectionTests {
    ...
    @Test func isConnectedStatus_connected_isTrue() {
        #expect(PluginManager.isConnectedStatus(.connected(url: "https://x.agent.muwa.ai")))
    }
    ...
    @Test func firstObservation_isNotReconnect() {
        #expect(
            !PluginManager.isReconnectTransition(
                from: nil,
                to: .connected(url: "https://x.agent.muwa.ai")
            )
        )
        #expect(
    ...
    @Test func connectedToConnected_isNotReconnect() {
        #expect(
            !PluginManager.isReconnectTransition(
                from: .connected(url: "https://x.agent.muwa.ai"),
                to: .connected(url: "https://x.agent.muwa.ai")
            )
        )
    }
    ...
    @Test func connectedToConnectedDifferentURL_isNotReconnect() {
        #expect(
            !PluginManager.isReconnectTransition(
                from: .connected(url: "https://old.agent.muwa.ai"),
                to: .connected(url: "https://new.agent.muwa.ai")
            )
        )
    }
