...
//
//  - Path-parameter extraction surfaces in `MuwaHTTPRequest.path_params`
...
struct PluginStaticFileContainmentTests {
    ...
    private func makeTemporaryRoot() throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("muwa-plugin-static-\(UUID().uuidString)", isDirectory: true)
