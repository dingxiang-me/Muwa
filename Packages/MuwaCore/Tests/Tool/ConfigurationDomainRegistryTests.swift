...
struct ConfigurationDomainRegistryTests {
    ...
    func writeToolNames_aggregateAcrossDomains() async {
        ...
        #expect(configureWrites.contains("muwa_provider_add"))
        #expect(configureWrites.contains("muwa_model_download"))
        #expect(configureWrites.contains("muwa_mcp_add"))
        #expect(configureWrites.contains("muwa_plugin_install"))
        #expect(configureWrites.contains("muwa_schedule_create"))
        #expect(configureWrites.contains("muwa_agent_create"))

        let configureAll = ToolRegistry.configureToolNames
        #expect(configureAll.isSuperset(of: configureWrites))
        #expect(configureAll.contains("muwa_status"))
        #expect(configureAll.contains("muwa_list"))
        #expect(configureAll.contains("muwa_describe"))
    }
    ...
    func register_marksToolsAsBuiltIn() async {
        ...
        // can reach them.
        #expect(builtIn.contains("muwa_provider_add"))
        #expect(builtIn.contains("muwa_model_download"))
        #expect(builtIn.contains("muwa_schedule_create"))
        #expect(builtIn.contains("muwa_agent_activate"))
    }
