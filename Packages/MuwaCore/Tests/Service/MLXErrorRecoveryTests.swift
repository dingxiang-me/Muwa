...
/// Guards `MLXErrorRecovery.installGlobalHandler()` — the muwa-side bootstrap
...
/// Muwa process down via `_assertionFailure` - taking every unrelated
...
/// fix lives in `NemotronHJANGTQ.swift`, but on the Muwa side we want the
