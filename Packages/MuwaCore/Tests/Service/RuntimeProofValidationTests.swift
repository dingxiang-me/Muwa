// Copyright 2026 Muwa AI. All rights reserved.
...
struct RuntimeProofValidationTests {
    ...
    func completeVisibleRowIsAcceptable() {
        let row = RuntimeProofRow(
            ...
            artifactPaths: ["/tmp/muwa-proof/summary.json"],
    ...
    func hybridCacheRequiresCompanionHit() {
        let row = RuntimeProofRow(
            ...
            artifactPaths: ["/tmp/muwa-proof/cache.json"],
    ...
    func mediaRowsRequireMediaProof() {
        let row = RuntimeProofRow(
            ...
            artifactPaths: ["/tmp/muwa-proof/audio.json"],
