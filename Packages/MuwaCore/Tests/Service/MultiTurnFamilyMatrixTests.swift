//
// Multi-turn x per-family capability matrix on the Muwa side.
//
// Companion to vmlx's MultiTurnFamilyMatrixTests. That suite locks the
// engine-side parser/dispatch invariants. This suite locks the muwa-
...
// it" — the engine just gets a chat message with parts. Muwa is the
