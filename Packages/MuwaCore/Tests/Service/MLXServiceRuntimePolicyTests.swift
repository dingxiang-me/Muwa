...
struct MLXServiceRuntimePolicyTests {
    ...
    @Test func localToolSupportFollowsBundleToolParserContract() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("muwa-tool-support-\(UUID().uuidString)", isDirectory: true)
    ...
    private static func lineCountTool() -> MuwaCore.Tool {
        MuwaCore.Tool(
            type: "function",
    ...
    private static func makeMediaCapabilityBundle(
        ...
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("muwa-media-cap-\(UUID().uuidString)", isDirectory: true)
