...
struct MCPHTTPHandlerTests {
    ...
    @Test func mcp_call_rejects_malformed_agent_header() async throws {
        ...
        request.httpMethod = "POST"
        request.setValue("application/json", forHTTPHeaderField: "Content-Type")
        request.setValue("not-a-uuid", forHTTPHeaderField: "X-Muwa-Agent-Id")
        request.authenticate()
...
private struct EchoTool: MuwaTool {
...
private struct NamedEchoTool: MuwaTool {
    let name: String
    let description: String = "Echo back the input JSON arguments"
