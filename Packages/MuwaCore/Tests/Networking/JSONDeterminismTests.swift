...
struct JSONDeterminismTests {
    ...
    func canonicalSerializationOptions_includeSortedKeys() throws {
        ...
        let data = try JSONSerialization.data(withJSONObject: dict, options: .muwaCanonical)
    ...
    func generationEventMapper_serializeArguments_sortsKeys() throws {
        ...
        let dataA = try JSONSerialization.data(withJSONObject: argsA, options: .muwaCanonical)
        let dataB = try JSONSerialization.data(withJSONObject: argsB, options: .muwaCanonical)
    ...
    func toolCanonicalize_fallback_normalisesSendableJSON() throws {
        ...
        let bytesA = try JSONSerialization.data(withJSONObject: canonical, options: .muwaCanonical)
        let bytesB = try JSONSerialization.data(withJSONObject: canonical, options: .muwaCanonical)
    ...
    /// produces different bytes; `muwaCanonical()` must produce the
    /// same bytes.
