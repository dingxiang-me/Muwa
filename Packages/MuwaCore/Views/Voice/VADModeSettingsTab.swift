    ...
    private var vadToggleCard: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            HStack(alignment: .top, spacing: 8) {
                ...
                Text(
                    "When enabled, Muwa will continuously listen for agent names. Say a agent's name to automatically open a chat with that agent.",
                    bundle: .module
                )
                .font(.system(size: 12))
                .foregroundColor(theme.secondaryText)
    ...
    private var wakeWordSettingsCard: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                TextField(text: $customWakePhrase, prompt: Text("e.g., Hey Muwa", bundle: .module)) {
                    Text("e.g., Hey Muwa", bundle: .module)
                }
