...
extension NSAttributedString.Key {
    ...
    static let blockquoteMarker = NSAttributedString.Key("muwa.blockquote")
    /// Marks a range as a heading that should have an underline (H1/H2)
    static let headingUnderline = NSAttributedString.Key("muwa.headingUnderline")
}
...
final class SelectableNSTextView: NSTextView {
    ...
    private func handleArtifactLink(_ url: URL) {
        ...
        let artifactsRoot = MuwaPaths.artifactsDir()
