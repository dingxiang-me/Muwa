...
extension NSAttributedString.Key {
    ...
    static let redactionPlaceholder = NSAttributedString.Key("MuwaRedactionPlaceholder")
    ...
    static let redactionDirection = NSAttributedString.Key("MuwaRedactionDirection")
}
