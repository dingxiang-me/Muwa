...
struct MasterMnemonicCard: View {
    ...
    private func saveAsTextFile() {
        ...
        panel.nameFieldStringValue = "muwa-recovery-phrase.txt"
    ...
    private func renderPlainText() -> String {
        ...
        var lines: [String] = []
        lines.append("MUWA MASTER RECOVERY PHRASE")
        ...
        lines.append("your Muwa identity. Muwa cannot recover this phrase for you.")
