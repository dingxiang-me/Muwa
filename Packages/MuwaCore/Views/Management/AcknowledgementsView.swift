...
struct AcknowledgementsView: View {
        ...
        VStack(spacing: 16) {
            HStack {
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text("Open source libraries used by Muwa", bundle: .module)
                        .font(.system(size: 14))
                        .foregroundColor(theme.secondaryText)
                }
    ...
    private var introSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            Text(
                "Muwa is built with the help of many excellent open source projects. We are grateful to the developers and maintainers of these libraries.",
                bundle: .module
            )
            .font(.system(size: 14))
            .foregroundColor(theme.secondaryText)
