...
/// `MuwaCore/Resources/Assets.xcassets`
public enum AgentMascot: String, CaseIterable, Identifiable, Sendable {
    case blue, green, orange, purple, red, yellow

    public var id: String { rawValue }
    public var assetName: String { "muwa-avatar-\(rawValue)" }

    /// The frog's signature color, used to theme surfaces around the mascot
    /// (e.g. the onboarding hero glow, avatar tint, and selection ring) so
    /// the UI reacts in the selected frog's actual color rather than a
    ...
    public var displayName: String {
        switch self {
        case .blue: return "Blue frog"
        case .green: return "Green frog"
        case .orange: return "Orange frog"
        case .purple: return "Purple frog"
        case .red: return "Red frog"
        case .yellow: return "Yellow frog"
        }
    }
    ...
    /// (`muwa-yellow-create` instead of `muwa-yellow-create`).
    ...
    public var createPoseAssetName: String {
        switch self {
        case .yellow: return "muwa-yellow-create"
        default: return "muwa-\(rawValue)-create"
        }
    }
}
