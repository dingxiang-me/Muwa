...
enum WalkthroughPage: Int, CaseIterable, Identifiable {
    ...
    var illustrationAsset: String {
        switch self {
        case .loop: return "muwa-tool"
        case .personal: return "muwa-built"
        case .privacy: return "muwa-data"
        }
    }
    ...
    var subtitle: LocalizedStringKey {
        ...
        case .personal:
            return
                "Set up a frog for each kind of work. It remembers your context, so you stop re-explaining yourself."
        case .privacy:
            return
