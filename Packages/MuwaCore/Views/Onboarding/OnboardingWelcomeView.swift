...
//  shell. No wordmark or eyebrow on this screen; the frog and the
...
struct WelcomeBody: View {
    ...
    var body: some View {
        ...
        // the CTA — consistent with the caption on the "Meet your frog" step.
        OnboardingHeroBody(
            illustrationAsset: "muwa-main",
...
struct WelcomeUsageOptIn: View {
    ...
    private var toggleButton: some View {
        Button {
            ...
            HStack(spacing: 7) {
                ...
                Text("Share anonymous usage data to help improve Muwa", bundle: .module)
    ...
    private var infoPopover: some View {
        Text(
            "We collect anonymous, aggregated usage data to learn which features are used so we can improve Muwa. It's completely anonymous and never includes your chats, prompts, files, or keys. You can turn this off anytime in Settings.",
            bundle: .module
        )
        .font(theme.font(size: 12))
