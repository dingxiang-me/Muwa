...
struct ChoosePluginsBody: View {
    ...
    var body: some View {
        OnboardingTwoColumnBody(
            illustrationAsset: "muwa-tool",
            leftHeadline: "Pick what your frog can do",
            leftBody:
                "Tools are little powers your frog can use, like reading the web or grabbing a file. Add a couple now, swap them in and out any time from Settings.",
