...
struct SandboxSetupBody: View {
    ...
    var body: some View {
        OnboardingTwoColumnBody(
            illustrationAsset: "muwa-sandbox",
            leftHeadline: "A safety net for your frog",
            leftBody:
                "When your frog installs packages, runs scripts, or fiddles with files, it does that in a tiny, walled-off workspace — separate from your Mac.",
            subtitle: "Where your frog runs anything that touches your system."
        ) {
        ...
        OnboardingGlassCard {
            VStack(alignment: .leading, spacing: 12) {
                ...
                bulletRow(
                    ...
                    detail: L("Lets your frog install packages, run scripts, and work with files like a real machine.")
                )
                bulletRow(
