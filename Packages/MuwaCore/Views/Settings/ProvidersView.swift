...
struct ProvidersView: View {
    ...
    private var emptyState: some View {
        VStack(spacing: 16) {
            ...
            Text("Connect to a remote MCP server to give Muwa more tools.", bundle: .module)
                .font(.system(size: 14))
...
private struct ProviderEditSheet: View {
    ...
    private var headerInfo: (icon: String, title: Text, subtitle: Text) {
        ...
        case .configureKnown(let template):
            return (
                ...
                Text("Sign in with your account to give Muwa access", bundle: .module)
            )
        case .configureCustom:
            return (
                "slider.horizontal.3",
    ...
    private func signInBlock(template: MCPProviderTemplate) -> some View {
        VStack(spacing: 10) {
            ...
            Text(
                "We'll open your browser to sign in. After approving, you'll be redirected back to Muwa.",
                bundle: .module
            )
            .font(.system(size: 11))
            .foregroundColor(themeManager.currentTheme.tertiaryText)
