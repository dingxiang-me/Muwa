...
//  but remain planned until their Muwa bridges land.
//
    ...
    var body: some View {
        ServerSettingsCard(
            ...
            ServerSettingsPlannedBanner(
                blurb:
                    "Implicit tool-choice policy is persisted only; OpenAI-compatible requests still use the request's explicit tool choice and Muwa chat-agent policy."
            )
