    ...
    private static let privacyFilter_0_19_0 = WhatsNewRelease(
        ...
        pages: [
            WhatsNewPage(
                ...
                description:
                    "Before anything leaves your Mac for a cloud model, Muwa can scan for phone numbers, emails, names, addresses, and other sensitive data and swap them for placeholders. Responses are restored on the way back."
            ),
            WhatsNewPage(
