...
enum ToolConfigurationStore {
    ...
    static func load() -> ToolConfiguration {
        ...
        if FileManager.default.fileExists(atPath: url.path) {
            do {
                ...
                print("[Muwa] Failed to load ToolConfiguration: \(error)")
            }
        }
    ...
    static func save(_ configuration: ToolConfiguration) {
        ...
        do {
            ...
            print("[Muwa] Failed to save ToolConfiguration: \(error)")
        }
    }
    ...
    private static func configurationFileURL() -> URL {
        ...
        return MuwaPaths.resolvePath(new: MuwaPaths.toolConfigFile(), legacy: "ToolConfiguration.json")
    }
}
