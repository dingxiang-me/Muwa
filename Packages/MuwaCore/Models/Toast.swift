...
public enum ToastConfigurationStore {
    private static var fileURL: URL {
        ...
        return MuwaPaths.resolvePath(new: MuwaPaths.toastConfigFile(), legacy: "ToastConfiguration.json")
    }
    ...
    public static func load() -> ToastConfiguration {
        ...
        do {
            ...
            print("[Muwa] Failed to load toast configuration: \(error)")
            return .default
        }
    }
    ...
    public static func save(_ configuration: ToastConfiguration) {
        do {
            ...
            print("[Muwa] Failed to save toast configuration: \(error)")
        }
    }
}
