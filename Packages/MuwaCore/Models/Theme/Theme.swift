...
public class ThemeManager: ObservableObject {
    ...
    private init() {
        print("[Muwa] ThemeManager: Initializing...")
        ...
        if let customTheme = ThemeConfigurationStore.loadActiveTheme() {
            print("[Muwa] ThemeManager: Restoring active theme '\(customTheme.metadata.name)'")
        ...
        Task { @MainActor [weak self] in
            ...
            print("[Muwa] ThemeManager: Found \(loaded.count) installed themes (deferred)")
        ...
        print("[Muwa] ThemeManager: Initialization complete")
    }
    ...
    func refreshInstalledThemes() {
        ...
        print("[Muwa] ThemeManager: Refreshed themes, found \(installedThemes.count) themes")
    }
