...
public enum ScheduleStore {
    ...
    private static var schedulesDirectory: URL {
        let dir = MuwaPaths.resolvePath(new: MuwaPaths.schedules(), legacy: "Schedules")
    ...
    public static func loadAll() -> [Schedule] {
        ...
        for file in files where file.pathExtension == "json" {
            do {
                ...
                print("[Muwa] Failed to load schedule from \(file.lastPathComponent): \(error)")
            }
        }
    ...
    public static func load(id: UUID) -> Schedule? {
        ...
        do {
            ...
            print("[Muwa] Failed to load schedule \(id): \(error)")
            return nil
        }
    }
    ...
    public static func save(_ schedule: Schedule) {
        ...
        do {
            ...
            print("[Muwa] Failed to save schedule \(schedule.id): \(error)")
        }
    }
    ...
    public static func delete(id: UUID) -> Bool {
        ...
        do {
            ...
            print("[Muwa] Failed to delete schedule \(id): \(error)")
            return false
        }
    }
