...
public enum MCPProviderTransport: String, Codable, Sendable, CaseIterable {
    /// Remote HTTP/SSE server (default for Muwa historically).
    case http
...
public enum MCPProviderConfigurationStore {
    public static func load() -> MCPProviderConfiguration {
        ...
        if FileManager.default.fileExists(atPath: url.path) {
            do {
                ...
                print("[Muwa] Failed to load MCPProviderConfiguration: \(error)")
            }
        }
    ...
    public static func save(_ configuration: MCPProviderConfiguration) {
        ...
        do {
            ...
            print("[Muwa] Failed to save MCPProviderConfiguration: \(error)")
        }
    }

    private static func configurationFileURL() -> URL {
        MuwaPaths.resolvePath(new: MuwaPaths.mcpProviderConfigFile(), legacy: "MCPProviderConfiguration.json")
    }
}
