...
public enum TTSConfigurationStore {
    ...
    private static func loadFromDisk() -> TTSConfiguration {
        let url = MuwaPaths.ttsConfigFile()
        ...
        do {
            ...
            print("[Muwa] Failed to load TTSConfiguration: \(error)")
            return TTSConfiguration.default
        }
    }
    ...
    private static func saveToDisk(_ configuration: TTSConfiguration) {
        ...
        do {
            ...
            print("[Muwa] Failed to save TTSConfiguration: \(error)")
        }
    }
}

extension Notification.Name {
    public static let ttsConfigurationChanged = Notification.Name("muwa.ttsConfigurationChanged")
}
