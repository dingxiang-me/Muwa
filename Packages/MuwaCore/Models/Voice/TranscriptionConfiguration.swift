...
public enum TranscriptionConfigurationStore {
    public static func load() -> TranscriptionConfiguration {
        ...
        do {
            ...
            print("[Muwa] Failed to load TranscriptionConfiguration: \(error)")
            return TranscriptionConfiguration.default
        }
    }
    ...
    public static func save(_ configuration: TranscriptionConfiguration) {
        ...
        do {
            ...
            print("[Muwa] Failed to save TranscriptionConfiguration: \(error)")
        }
    }

    private static func configurationFileURL() -> URL {
        MuwaPaths.resolvePath(new: MuwaPaths.transcriptionConfigFile(), legacy: "TranscriptionConfiguration.json")
    }
}
