...
struct FileWriteTool: MuwaTool, PermissionedTool {
    let name = "file_write"
    let description =
...
struct FileEditTool: MuwaTool, PermissionedTool {
    let name = "file_edit"
    let description =
...
struct FileOperationHistoryTool: MuwaTool {
...
struct FileUndoTool: MuwaTool, PermissionedTool {
    let name = "file_undo"
    let description =
...
struct FileSearchTool: MuwaTool {
...
struct ShellRunTool: MuwaTool, PermissionedTool {
    let name = "shell_run"
    let description =
...
struct GitCommitTool: MuwaTool, PermissionedTool {
    let name = "git_commit"
    let description =
...
enum FolderToolFactory {
    ...
    static func buildCoreTools(rootPath: URL) -> [MuwaTool] {
    ...
    static func buildGitTools(rootPath: URL) -> [MuwaTool] {
        return [
