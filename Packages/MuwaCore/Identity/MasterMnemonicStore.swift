...
//  `com.muwa.account` service, gated behind biometric auth on read.
...
public struct MasterMnemonicStore: Sendable {
    ...
    private static func addToKeychain(data: Data, synchronizable: Bool) -> OSStatus {
        var query: [String: Any] = [
            ...
            kSecAttrLabel as String: "Muwa Recovery Phrase",
        ]
        if synchronizable {
    ...
    /// Remove the stored phrase. Used by `MuwaIdentity.wipe()` so a
