...
public final class RevocationStore: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.muwa.revocations", attributes: .concurrent)
    private var revokedKeys: Set<String> = []
    private var counterThresholds: [String: UInt64] = [:]

    private static let keychainService = "com.muwa.revocations"
    ...
    public func revokeKey(address: MuwaID, nonce: String) {
    ...
    public func revokeAllBefore(address: MuwaID, counter: UInt64) {
