...
//  Muwa
//
//  Low-level cryptographic helpers for Muwa Identity:
...
func signPayload(_ payload: Data, privateKey: Data) throws -> Data {
    try signWithPrefix(payload, privateKey: privateKey, prefix: "Muwa Signed Message")
}

func signAccessPayload(_ payload: Data, privateKey: Data) throws -> Data {
    try signWithPrefix(payload, privateKey: privateKey, prefix: "Muwa Signed Access")
}

func signPairingPayload(_ payload: Data, privateKey: Data) throws -> Data {
    try signWithPrefix(payload, privateKey: privateKey, prefix: "Muwa Signed Pairing")
}
...
func signPairingServerPayload(_ payload: Data, privateKey: Data) throws -> Data {
    try signWithPrefix(payload, privateKey: privateKey, prefix: "Muwa Signed Pairing Server")
}
...
func pairingServerSigningPayload(agentAddress: String, nonce: String) -> Data {
    Data("muwa-pairing-server-v1:\(agentAddress.lowercased()):\(nonce)".utf8)
}
...
func signInvitePayload(_ payload: Data, privateKey: Data) throws -> Data {
    try signWithPrefix(payload, privateKey: privateKey, prefix: "Muwa Signed Invite")
}
...
func signSecureChannelPayload(_ payload: Data, privateKey: Data) throws -> Data {
    try signWithPrefix(payload, privateKey: privateKey, prefix: "Muwa Secure Channel")
}
...
/// Recover the signer's Muwa address from a payload and its 65-byte recoverable signature.
/// The `domainPrefix` must match the prefix used during signing.
func recoverAddress(payload: Data, signature: Data, domainPrefix: String) throws -> MuwaID {
...
/// Derive a checksummed Muwa ID from a secp256k1 private key.
func deriveMuwaId(from privateKey: Data) throws -> MuwaID {
...
/// Mixed-case checksum encoding for an Muwa ID.
