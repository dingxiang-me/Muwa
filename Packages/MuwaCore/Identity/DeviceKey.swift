...
public struct DeviceKey: Sendable {
    private static let keyIdKey = "com.muwa.device.keyId"
    private static let deviceIdKey = "com.muwa.device.deviceId"
    private static let softwareMarker = "com.muwa.device.software"
    ...
    public static func getAttestation(challenge: Data) async throws -> Data {
        guard let keyId = UserDefaults.standard.string(forKey: keyIdKey) else {
            throw MuwaIdentityError.deviceNotAttested
        }
