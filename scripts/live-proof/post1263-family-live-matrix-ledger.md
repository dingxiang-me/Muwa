...
| MiniMax M2.7 JANG_K | pending | | local sibling model id `minimax-m2.7-jang_k-crack` exists; run after deciding whether full-KV MiniMax rows should require disk L2 hits or accept prefix/paged cache reuse |
