...
APP="$1"
TEST_ROOT="${2:-/tmp/muwa-keychain-free-ui-proof-$(date +%Y%m%d-%H%M%S)}"
...
launchctl setenv MUWA_DISABLE_KEYCHAIN_FOR_TESTS 1
launchctl setenv MUWA_TEST_ROOT "$TEST_ROOT"
